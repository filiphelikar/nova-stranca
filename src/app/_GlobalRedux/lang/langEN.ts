export default {
  ...
  Projects: {
    ...
    infoLocal:
      "Local Chat is a chat application that allows users to communicate in real time. The app uses Firebase database for managing users and their messages. Although the login logic is implemented on the front end, the project showcases my abilities in working with databases and real-time communication.",
    infoPhoto:
