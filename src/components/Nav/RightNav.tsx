      ...
      <ul className={Styles.ul} ref={navRef}>
        ...
        <li>
          <Link
            onClick={() => setOpen(!open)}
            scroll={false}
            style={{ color: isActive("/project") ? "grey" : "" }}
            href="/project"
          >
        ...
        <li>
          <Link
            onClick={() => setOpen(!open)}
            scroll={false}
            style={{ color: isActive("/about-me") ? "grey" : "" }}
            href="/about-me"
          >
        ...
        <li>
          <Link
            onClick={() => setOpen(!open)}
            scroll={false}
            style={{ color: isActive("/contact") ? "grey" : "" }}
            href="/contact"
          >
